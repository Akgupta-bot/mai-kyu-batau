...
import spaceBackground from '../assets/pexels-philippedonn-1169754.jpg';
...
const PathUI = () => {
  ...
  return (
    <>
      ...
      {/* ✅ Profile Panda Button in top-right */}
        ...
        <div className="relative w-full max-w-2xl h-full flex items-center justify-center">
          ...
          <div className="relative z-10 w-full h-full">
            {levels.map((level) => (
              ...
              >
                <motion.div
                  className={`w-24 h-24 rounded-full flex items-center justify-center p-2 transition-all duration-300 bg-slate-900/50 backdrop-blur-sm border-2 ${level.status === "locked"
                      ? "border-slate-600"
